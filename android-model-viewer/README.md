...
- **Contextual Modals**: Features like model loading and settings are presented as `DialogFragment`s, allowing users to make changes while keeping the 3D scene visible for immediate feedback.
